...
<body>
				...
				<div class="navbar navbar-fixed-top navbar-default">
					<div class="navbar-header">
						<a href="?menu=home" class="navbar-brand" style="margin-top: -23px;">
							<img alt="Brand" src="../images/logo_adam_electric.png" width="60px" >
						</a>
					</div>
	...
	<footer class="container-fluid bg-4 text-center">
		<p>
		  	<strong>Copyright&nbsp;&copy;&nbsp;2024 <a target="_blank" href="https://www.instagram.com/adamrzkyrldy?igsh=MXY4ZWY1ODNxYmprOA==">adamrzkyrldy</a>.</strong>&nbsp;
		  	<br>
