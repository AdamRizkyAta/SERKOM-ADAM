			...
			<?php if(isset($_GET['excel'])){ ?>
				...
				<?php }else{ ?>
					<td style="margin-top: -20px;" width="15%" valign="top">
						<img src="../images/logo_adam_electric.png" width="100px" height="100px">
					</td>
				<?php } ?>
			<td colspan="10" align="left">
				<h4 style="margin-top: 10px;margin-left: -10px;">PERUSAHAAN PEMBAYARAN LISTRIK</h4>
				<h1 style="margin-top: -20px;margin-left: -10px;" >ADAM ELECTRIC
				<h5 style="margin-top: -20px;margin-left: -10px;">Jl. Damai 3 , Kec. Cipayung, Kel. Cilangkap, Jakarta Timur, 13870  </h5>
			</td>
		</tr>
