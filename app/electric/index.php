...
<body style="background:url('../images/logo_adam_electric.png');">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							<div style="margin-top: 5px;margin-bottom: 5px;">
								<img src="../images/logo_adam_electric.png" alt="logo" class="logo" width="90px">
							</div>
